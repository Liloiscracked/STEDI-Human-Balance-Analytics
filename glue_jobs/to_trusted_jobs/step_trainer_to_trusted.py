...
customer_trusted_node1767353916594 = glueContext.create_dynamic_frame.from_options(format_options={"multiLine": "false"}, connection_type="s3", format="json", connection_options={"paths": ["s3://mo-project-cutomers-trusted"], "recurse": True}, transformation_ctx="customer_trusted_node1767353916594")
...
SqlQuery0 = '''
select * from step_trainer_landing join customer_trusted 
on customer_trusted.serialnumber = step_trainer_landing.serialNumber
'''
SQLQuery_node1767354556237 = sparkSqlQuery(glueContext, query = SqlQuery0, mapping = {"step_trainer_landing":steptrainerlanding_node1767354516314, "customer_trusted":customer_trusted_node1767353916594}, transformation_ctx = "SQLQuery_node1767354556237")
